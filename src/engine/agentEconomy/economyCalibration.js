export const AGENT_ECONOMY_CALIBRATION_VERSION = 2;

export const DAYS_PER_QUARTER = 30;
export const FOOD_PER_PERSON_PER_QUARTER = 2.05;
export const DAILY_FOOD_TARGET_PER_PERSON = FOOD_PER_PERSON_PER_QUARTER / DAYS_PER_QUARTER;
export const FOOD_STOCK_TARGET_PER_PERSON = 2;

export const MIN_TRADE_QUANTITY = 0.05;
export const QUANTITY_PRECISION = 4;
export const PRODUCTION_INPUT_BUFFER_DAYS = 7;

export const LEARNED_PRICE_FLOOR_MULTIPLIER = 0.6;
export const LEARNED_PRICE_CEILING_MULTIPLIER = 2.5;
